...
CREATE TABLE `dt_layanan_dokumen` (
  ...
  `surat_permohonan_luar` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'surat permohonan untuk keluar negeri',
  ...
  `pas_foto_crmh_dalam` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'pas foto untuk penceramah kedalam negeri',
