...
CREATE TABLE `dt_layanan_dokumen` (
  ...
  `ktp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `pas_foto_crmh_dalam` int NOT NULL COMMENT 'pas foto untuk penceramah kedalam negeri',
