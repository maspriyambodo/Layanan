...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/app/img/Logo_B_Islam.png" type="image/x-icon">
    <link rel="icon" href="<?php echo base_url(); ?>assets/app/img/Logo_B_Islam.png" type="image/x-icon">
