        ...
        <div class="widget-bg">
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
              <form action="<?php echo site_url('users/zawaf/simpanedit_instansi_laz');?>" method="post">
                <fieldset>
            ...
            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
              <form method="post" action="<?php echo site_url('users/zawaf/simpanedit_lampiran_laz');?>" enctype="multipart/form-data">
                <fieldset>
