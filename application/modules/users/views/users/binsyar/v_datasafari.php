    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>users/binsyar/joinan_safari',
                    params: {}
                },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>users/binsyar/hapus_dt_safari';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>users/binsyar/editsafari/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
