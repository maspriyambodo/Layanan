...
class Binsyar extends MX_Controller {
    ...
    public function datapermohonan() {
        $this->template->setPageId("ZAKAT_WAKAF");
        $data = array();

        $sitetitle = "Data Permohonan Zakat dan Wakaf";
        $pagetitle = "Data Permohonan Zakat dan Wakaf";
    ...
    {
        $this->template->setPageId("SUB_ZAKAT_LKSPWU");
