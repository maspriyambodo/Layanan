...
class Zawaf extends MX_Controller {
    ...
    public function datalkspwu() {
        ...
        $view = "/operator/zawaf/v_datalkspwu";
        $breadcrumbs = array(
                array(
                    "title" => "",
                    "link" => "",
    ...
    public function lkspwu()
    {
        ...
        $view = "/operator/zawaf/v_tambahsatu";
        $breadcrumbs = array(
                array(
                    "title" => "",
                    "link" => "",
    ...
    public function laz()
    {
        ...
        $view = "/operator/zawaf/v_tambahdua";
        $breadcrumbs = array(
                array(
                    "title" => "",
                    "link" => "",
    ...
    public function simpan_forma()
    {
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            echo "<script>alert('Data berhasil disimpan');window.location = '".site_url('operator/zawaf/datalaz/')."';</script>";
        } else {
            return $this->lkspwu();
        }
    }
    ...
    function editlkspwu($id)
    {
        ...
        $view = "/operator/zawaf/v_editdata_lkspwu";
        $breadcrumbs = array(
                array(
                    "title" => "",
                    "link" => "",
    ...
    function editlaz($id)
    {
        ...
        $view = "/operator/zawaf/v_editdata_laz";
        $breadcrumbs = array(
                array(
                    "title" => "",
                    "link" => "",
