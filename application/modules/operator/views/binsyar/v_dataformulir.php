    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>operator/binsyar/ambil_formulir',
                    params: {}
                },
            },
            trackOver: true,
            ...
            columns: [{
                ...
                },
                {
                    ...
                    o.value = ''
                        ...
                        +
                                ('<div class="btn-group" role="group" aria-label="Control button"><a class="btn btn-default btn-xs" href="javascript:;" onclick="Page.Tambah(\'' + o.value + '\')" data-toggle="tooltip" data-html="true" title="Tambah"><i class="fas fa-plus text-primary"></i> Data</a>')
...
<?php endif; ?>
    ...
    Page.Tambah = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/binsyar/formulir/' + id;
        }
    };
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>operator/binsyar/hapus_dt_impor';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/binsyar/editimpor/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
