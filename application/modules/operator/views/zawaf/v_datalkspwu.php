    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>operator/zawaf/joinan_lkspwu',
                    params: {}
                },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>operator/zawaf/hapus_dt_lkspwu';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/zawaf/editlkspwu/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
