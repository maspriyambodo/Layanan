    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>operator/dt_join_users',
                    params: {}
                },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>operator/hapus_dt_user/';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/editusers/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
