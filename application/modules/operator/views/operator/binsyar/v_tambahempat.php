<form method="post" action="<?php echo site_url('operator/binsyar/simpan_formd');?>" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      ...
                      <button class="btn btn-outline-secondary btn-primary" type="button" id="btn-tambah-form">Tambah</button>
                    </div>
              ...
              <!-- <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <div class="input-group mb-6">
                    ...
                    <input type="text" class="form-control" name="pddk[]" placeholder="" aria-label="" aria-describedby="basic-addon1">
