    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>operator/binsyar/joinan_ekspor',
                    params: {}
                },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>operator/binsyar/hapus_dt_ekspor';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/binsyar/editekspor/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
