    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php //echo base_url(); ?>operator/binsyar/joinan_kegiatan',
                    params: {}
                },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    Page.Delete = function(id) {
        ...
        swal({
            ...
            if (result) {
                ...
                var url = '<?php echo base_url(); ?>operator/binsyar/hapus_dt_kegiatan';
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>operator/binsyar/editkegiatan/' + id;
        }
    };
    $(function() {
        Page.InitGrid();
