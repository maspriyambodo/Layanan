...
//            $this->M_Interaksi->Insertpict($picture);
    ...
    public function Detail($id) {
        ...
        if (empty($data['detil'])) {
            ...
            $sitetitle = $data['detil']['nama_direktorat'] . ' | ' . $data['detil']['nama_layanan'];
            if ($data['detil']['id_stat'] == 1) {
                $pagetitle = "<b>Status: </b><span class='text-info'>" . $data['detil']['nama_stat'] . "</span>";
            } elseif ($data['detil']['id_stat'] == 2) {
                $pagetitle = "<b>Status: </b><span class='text-warning'>" . $data['detil']['nama_stat'] . "</span>";
            } elseif ($data['detil']['id_stat'] == 3) {
                $pagetitle = "<b>Status: </b><span class='text-success'>" . $data['detil']['nama_stat'] . "</span>";
            } else {
                $pagetitle = "<b>Status: </b><span class='text-danger'>" . $data['detil']['nama_stat'] . "</span>";
            }
            $view = "lkspwu/detail";
            $breadcrumbs = [
                [
