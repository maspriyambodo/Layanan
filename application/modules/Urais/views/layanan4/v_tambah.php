...
<form action="<?php echo base_url('Urais/Layanan_4/Simpan/'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input id="tgl_awal_keg" type="text" name="tgl_awal_keg" class="form-control datepicker" required="" autocomplete="off" onkeydown="return false;"/>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <select id="pddk_formal" name="pddk_formal[]" class="form-control custom-select" required="">
                            <option value="">Pilih</option>
                            <option value="1">SD</option>
                            <option value="2">SLTP/MTS</option>
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input id="pddk_non" type="text" name="pddk_non[]" autocomplete="off" required="" class="form-control"/>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="scan_doks" class="form-control" type="file" name="scan_doks[]" required="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
...
<script>
    ...
    function Save() {
        var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, vx, vxx, w, x, y, z, ab, ac, ad, adx, ae, az, af, ag, ah;
        ...
        vx = $('select[name="pddk_formal"]').val();
        vxx = $('input[name="pddk_non"]').val();
        ...
        adx = $('input[name="scan_doks"]').val();
        ae = $('input[name="paspor_narsum"]').val();
        az = $('input[name="ktp_docs"]').val();
        ...
        if (a == "") {
            ...
            toastr.warning("Harap pilih pendidikan formal!");
        } else if (vxx == "") {
            toastr.warning("Harap masukkan pendidikan non formal!");
        } else if (w == "") {
            ...
            toastr.warning("Harap masukkan scan ktp!");
        } else if (af == "") {
    ...
    function Tambah() {
        ...
        $("#repeat_narsum").append(
                ...
                + '<div class="row"> <div class="col-md"> <div class="form-group"> <label>Pendidikan Formal:</label> <select id="pddk_formal" name="pddk_formal[]" class="form-control custom-select" required=""> <option value="">Pilih</option> <option value="1">SD</option> <option value="2">SLTP/MTS</option> <option value="3">SMK/SMA</option> <option value="4">D3</option> <option value="5">S1</option> <option value="6">S2</option> </select></div></div> <div class="col-md"> <div class="form-group"> <label>Pendidikan Non Formal:</label> <input id="pddk_non" type="text" name="pddk_non[]" autocomplete="off" required="" class="form-control"/> </div></div> </div>'
                + '<div class="row"> <div class="col-md-4"> <div class="form-group"> <label for="cv_narsum">CV Penceramah:</label> <input id="cv_narsum" class="form-control" type="file" name="cv_narsum[]" required=""/> </div> </div> <div class="col-md-4"> <div class="form-group"> <label for="scan_doks">Scan Sertifikat:</label> <input id="scan_doks" class="form-control" type="file" name="scan_doks[]" required=""/> </div> </div> <div class="col-md-4"> <div class="form-group"> <label for="alamat">Alamat:</label> <input type="text" name="alamat_ceramah[]" class="form-control" required="" autocomplete="off"/> </div> </div> </div>'
                + '<div class="row"> <div class="col-md"> <div class="form-group"> <label>Fotocopy Passport:</label> <input id="paspor_narsum" class="form-control" type="file" name="paspor_narsum[]" required=""> </div> </div> <div class="col-md"> <div class="form-group"> <label>Scan KTP:</label> <input id="ktp_docs" class="form-control" type="file" name="ktp_docs[]" required=""> </div> </div> <div class="col-md"> <div class="form-group"> <label>Pas Foto:</label> <input id="foto_narsum" class="form-control" type="file" name="foto_narsum[]" required=""> </div> </div> </div>'
        ...
        $.ajax({
            url: "<?php echo base_url('Urais/Layanan_3/Get_provinsi/'); ?>",
            type: 'get',
            dataType: 'json',
            cache: true,
