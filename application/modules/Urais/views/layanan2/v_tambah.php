...
<script>
    ...
    function Tambah() {
        ...
        $("#repeat_narsum").append(
                ...
                + '<div class="text-right"><button class="btn" type="button" Title="Hapus" onclick="Del_narsum(' + nextform + ')"><i class="fas fa-minus-square" style="color:red;"></i> Hapus</button></div></div>'
                );
        $.ajax({
