                ...
                <div class="col-md">
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="ktp_keg" name="ktp_keg" required="" value="<?php echo $detil[0]->ktp_keg; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="proposal" name="proposal" required="" value="<?php echo $detil[0]->proposal_keg; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="sp_keg" name="sp_keg" required="" value="<?php echo $detil[0]->surat_permohonan_keg; ?>">
                        </div>
                    </div>
                </div>
            </div>
