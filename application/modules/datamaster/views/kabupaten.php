...
<script type="text/javascript">
    ...
    Page.InitGrid = function() {
        ...
        var grid = new FancyGrid({
            ...
            data: {
                ...
                remoteSort: false,
                proxy: {
                    url: '<?php echo base_url(); ?>datamaster/address/populateKabupatenAllAttributes',
                    params: {}
                },
            },
            trackOver: true,
            ...
            tbar: [{
                ...
                paramsText: 'Columns'
                    ...
                    handler: function() {
                        // alert("add")
                        window.location.href = '<?php echo site_url("datamaster/address/form_kabupaten"); ?>';
                    },
                }, <?php endif; ?>],
            paging: true,
            defaults: {
    ...
    Page.Edit = function(id) {
        if (id != '') {
            window.location.href = '<?php echo base_url(); ?>datamaster/address/form_kabupaten/' + id;
        }
    };
    Page.Remove = function(id) {
        // swal("Delete function is still under development!")
