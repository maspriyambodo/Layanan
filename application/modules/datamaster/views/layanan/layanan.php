...
<script type="text/javascript">
    ...
    thousandSeparator: '.',
            ...
            pageSize: 10,
                    ...
                    remoteSort: false,
                    proxy: {
                    url: '<?php echo base_url('datamaster/Layanan/Get_all'); ?>',
                            params: {}
                    },
            },
            trackOver: true,
            ...
            type: 'search',
                ...
                type: 'button',
                        ...
                        width: 120,
                        handler: function() {
                        window.location.href = '<?php echo site_url("datamaster/Layanan/Tambah/"); ?>';
                        },
                }, <?php endif; ?>
            ],
            paging: true,
...
<?php endif; ?>
    ...
    var url = '<?php echo base_url('datamaster/Layanan/Delete/'); ?>';
    ...
    if (id != '') {
    window.location.href = '<?php echo base_url('datamaster/Layanan/Edit/'); ?>' + id;
    }
    };
    $(function() {
    Page.InitGrid();
