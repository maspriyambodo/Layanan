...
<script type="text/javascript">
    ...
    thousandSeparator: '.',
            ...
            pageSize: 10,
                    ...
                    remoteSort: false,
                    proxy: {
                    url: '<?php echo base_url('datamaster/Status/Get_all'); ?>',
                            params: {}
                    },
            },
            trackOver: true,
...
<?php endif; ?>
    ...
    var url = '<?php echo base_url('datamaster/Status/Delete/'); ?>';
    ...
    if (id != '') {
    window.location.href = '<?php echo base_url('datamaster/Status/Edit/'); ?>' + id;
    }
    };
    $(function() {
    Page.InitGrid();
