...
$config['DX_website_name'] = 'Alfabet.V2';
$config['DX_webmaster_email'] = 'webmaster@benk.com';
...
$config['DX_captcha_width'] = 120;
$config['DX_captcha_height'] = 32;
$config['DX_captcha_font_size'] = '24px'; 
...
$config['DX_deny_uri'] = '/accessdenied/';
$config['DX_login_uri'] = '/signin/';
$config['DX_banned_uri'] = '/accessbanned/';
$config['DX_activate_uri'] = '/useractivation/';
$config['DX_reset_password_uri'] = '/resetpassword/';
...
// URI Locations
$config['DX_logout_uri'] = '/signout/';
$config['DX_register_uri'] = '/register/';
$config['DX_forgot_password_uri'] = '/forgotpassword/';
$config['DX_change_password_uri'] = '/changepassword/';
$config['DX_cancel_account_uri'] = '/cancelaccount/';

// Forms view
$config['DX_login_view'] = 'auth/login_form';//'account/signin';
$config['DX_register_view'] = 'account/register';
$config['DX_forgot_password_view'] = 'account/forgot_password';
$config['DX_change_password_view'] = 'account/change_password';
$config['DX_cancel_account_view'] = 'account/cancel_account';
